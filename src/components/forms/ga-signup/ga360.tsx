        ...
        >
          ...
          <AuFieldset className="fieldset-group">
            ...
            <CheckBoxField
              id="cbagree"
              label="I agree"
              legend={`I agree to the <a href="/google-analytics-360/terms-of-service">Terms of Service</a> and have the financial delegation to spend the required amount for this subscription`}
            />
            <CheckBoxField
              id="cbnewsletter"
              label="Yes"
