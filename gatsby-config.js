module.exports = {
  ...
  plugins: [
    ...
    },
    {
      ...
      options: {
        endpoint:
          "https://digital.us4.list-manage.com/subscribe/post?u=d0335b76e10d6df0a6eaab0d2&amp;id=52cdb49028", // string; add your MC list endpoint here; see instructions below
